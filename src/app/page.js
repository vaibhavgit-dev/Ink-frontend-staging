        ...
        <div className="relative wrapper homepage">
          ...
          <div className="main">
            <section className="slider relative z-1">
              ...
              <BannerCarousel
              images={[
                '/Homepage Banner Creatives1 (1).jpg',
                '/Homepage Banner Creatives2 (1).jpg',
                '/Homepage Banner Creatives3 (1).jpg'
              ]}
            />
          ...
          <div className="bg-[#ffffff] w-full relative z-[11]">
            ...
            <section id="about-author" className="container mx-auto text-center py-10 mt-20 pt-0 p-0 lg:w-[70%] lg:mx-auto"           >
                ...
                <div className="lg:p-8 pt-10 mx-auto">
                  <div className="relative z-[10]">
                    ...
                    <p className="text-gray-700 text-center mb-4 text-lg leading-relaxed">
                      Ami Ganatra is an author and researcher known for her work on Indian
                      history, culture, and ancient civilizations. Her writings focus on
                      presenting historical narratives through extensive research and
                      factual interpretation.
                    </p>

                    {/* Social Links */}
                    {/* <ul className="list-disc flex flex-wrap justify-center gap-6 pb-6">
                      <li className="list-none hover:underline hover:text-[#007DD7]">
                    ...
                    <div className="w-full">
                      <h6 className="text-[#007DD7] text-md">
                        <Link href="/authors/ami-ganatra" className="text-blue-500 underline">
